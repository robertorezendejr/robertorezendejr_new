...
$(document).ready(function() {
    var description = new Typed('#description', {
        strings: ['Apaixonado por tecnologia^2500', 'Programador Frontend^2500', 'Estudo novas Tecnologias^2500', 'Apaixonado por Música^2500', 'Pai do Arthur, Lorenzo e João^2500',  'Coordenador de Parada de Produção^2500'],
        shuffle: true,
        loop: true,
        typeSpeed: 100,
        backSpeed: 100,
